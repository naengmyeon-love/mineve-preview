...
export const images = {
  ...
  basalt: "/images/basalt.jpg",
  sea: "/images/coast.jpg",
  salt: "/images/salt.jpg",
  saltField: "/images/salt.jpg",
...
export const products: Product[] = [
  ...
  },
  {
    ...
    size: "90 g",
    price: 24000,
    description: "제주의 허브 향이 결정 사이에 은은하게 머무는 피니싱 솔트.",
    image: images.forest,
    detail: "바질과 로즈메리의 푸른 향을 굵은 소금 결정과 낮은 온도에서 천천히 블렌딩했습니다.",
    use: "구운 채소와 생선, 부드러운 치즈 위에 마지막 한 꼬집을 더합니다.",
    ingredients: "천일염 92%, 바질, 로즈메리, 제주 감귤피",
  },
  {
    slug: "jeju-mineral-salt-gift-set",
    line: "salt",
    name: "제주 미네랄 솔트 기프트 세트",
    english: "Jeju Mineral Salt Gift Set",
    size: "4 × 45 g",
    price: 46000,
    description: "결정과 입자, 향의 차이를 한 상자에 담은 네 가지 미네랄 솔트.",
    image: images.table,
    detail: "오리지널, 파인, 허브, 시트러스 솔트를 작은 유리병에 담았습니다.",
    use: "요리의 시작과 마무리에 입자와 향을 달리해 사용하세요.",
    ingredients: "천일염, 바질, 로즈메리, 제주 감귤피",
  },
  {
  ...
  },
  {
    ...
    image: images.ritual,
    detail: "가벼운 식물성 오일과 미네랄 유래 보습 성분이 피부에 오래 남지 않도록 설계했습니다.",
    use: "목욕이나 샤워 직후 물기가 조금 남은 피부에 부드럽게 펴 바릅니다.",
